...
SimpleEQAudioProcessor::createParmeterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Quality", "Peak Quality", juce::NormalisableRange<float>(0.1, 10.f, 0.5f, 1.f),1.f));
